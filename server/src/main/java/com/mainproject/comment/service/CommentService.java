...
public class CommentService {
    ...
    public Comment updateComment(Comment comment, Long commentId, String email) {
        ...
        if (member.getMemberId() != findComment.getMember().getMemberId())
            throw new BusinessLogicException(ExceptionCode.NOT_POSTS_MEMBER);
    ...
    private Comment findVerifiedComment(long commentId) {
        ...
        if (findComment.getCommentStatus() != Comment.CommentStatus.COMMENT_REGISTERED)
            throw new BusinessLogicException(ExceptionCode.COMMENT_NOT_CHANGED);
